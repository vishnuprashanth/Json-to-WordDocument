...
namespace MarkdownToOpenXML
{
    class RunBuilder
    {
        ...
        public RunBuilder(string md, Paragraph para)
        {
            ...
            BulletList = new PatternMatcher(PatternMatcher.Pattern.BulletList);
            BulletList.FindMatches(md, ref Tokens);
        ...
        {
            return (Bold.HasMatches() || Italic.HasMatches() || Underline.HasMatches() || Hyperlinks.HasMatches() || Hyperlinks_Text.HasMatches() || Tab.HasMatches()) || BulletList.HasMatches();  
        }
